...
public class AndroidDeviceAdapter {
	...
	private static final String UNUSEABLE_DEVICE_DATA = "List of devices attached";
	...
	public AndroidDevice[] getAndroidDevicesNotUseL() {
		StringBuffer devicesData = CommandLine.execCommandAndGetResult(GET_DEVICE_COMMAND_NO_L);
		if (devicesData == null) {
			return null;
		}
	...
	private AndroidDevice getAndroidDeviceFromDeviceData(String deviceData) {
		...
		if (formatedDeviceData.equals(UNUSEABLE_DEVICE_DATA)) {
			return null;
		}
